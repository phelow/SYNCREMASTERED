...
public class WordDecay : MonoBehaviour {
	...
	[SerializeField]private float m_timeDelay = 10.0f;
	[SerializeField]private float m_waitTime;
	[SerializeField]private float m_intervalTime;
	[SerializeField]private Rigidbody2D m_rb;

	[SerializeField]private bool m_erase;
	[SerializeField]private int m_nextScene;
	[SerializeField]private bool m_lastLevel = false;
	[SerializeField]private bool m_goodEnding = false;

	[SerializeField]private static int s_eraseInput;
	...
	[SerializeField]private float m_textRatioX;
	[SerializeField]private float m_textRatioY;
	[SerializeField]private bool m_triggerEnding = true;
	[SerializeField]private bool m_invisAtStart = false;
